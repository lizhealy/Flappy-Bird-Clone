...
//  Flappy Bird
//
//  Created by Liz Healy on 3/2/17.
//  Copyright © 2017 Liz Healy. All rights reserved.
//
...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    func makePipes() {
        ...
        pipe2.position = CGPoint(x: self.frame.midX + self.frame.width, y: self.frame.midY - (pipe1Texture.size().height / 2) - gapHeight / 2 + pipeOffset)
    ...
    func didBegin(_ contact: SKPhysicsContact) {
        ...
        if gameOver == false {
            ...
            if contact.bodyA.categoryBitMask == ColliderType.Gap.rawValue || contact.bodyB.categoryBitMask == ColliderType.Gap.rawValue {
                ...
                print("Gap Collide: Add One to score")
